...
function App() {
    ...
    const getValues = Object.values(champion).map((entrie, index)=>{
      const img = entrie.id
      
      return(
        // console.log(entrie,index),
        <Item key={index}>
          <ChampImg src={"http://ddragon.leagueoflegends.com/cdn/11.17.1/img/champion/" + (img) + ".png"} alt={img} width="22px" height="22px"/>
